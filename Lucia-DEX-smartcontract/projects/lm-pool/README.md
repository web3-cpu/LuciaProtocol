...
It will be deployed automatically by MasterChef with LmPoolDeployer whenever
there is a new liquidity mining campaign.
As for testing, please check the tests in MasterChef which is the main testing
