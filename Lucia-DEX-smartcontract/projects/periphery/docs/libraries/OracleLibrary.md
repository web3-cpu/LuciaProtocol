...
Calculates time-weighted means of tick and liquidity for a given LuciaSwap pool
...
| Name | Type    | Description                                       |
| ---- | ------- | ------------------------------------------------- |
| pool | address | Address of LuciaSwap pool that we want to observe |
...
| Name | Type    | Description               |
| ---- | ------- | ------------------------- |
| pool | address | Address of LuciaSwap pool |
