...
} from '@luciaswap/core/artifacts/contracts/LuciaPoolDeployer.sol/LuciaPoolDeployer.json'
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '@uniswap/v2-core/build/UniswapV2Factory.json'
import { Fixture } from 'ethereum-waffle'
import { ethers, waffle } from 'hardhat'
import { ILuciaFactory, IWETH9, MockTimeSwapRouter } from '../../typechain-types'
...
const v3CoreFactoryFixture: Fixture<{ deployer: Contract; factory: ILuciaFactory }> = async ([wallet]) => {
