...
Record the LCI amount belong to

### constructor

```solidity
constructor(IERC20 _LCI, INonfungiblePositionManager _nonfungiblePositionManager, address _WETH) public
```
...
| ---------------------------- | --------------------------- | ------------------------------------------ |
| \_LCI                        | IERC20                      | The LCI token contract address.            |
...
| Name         | Type    | Description            |
| ------------ | ------- | ---------------------- |
| LCIPerSecond | uint256 | LCI reward per second. |
...
| Name   | Type    | Description             |
| ------ | ------- | ----------------------- |
| \_pool | address | Address of the V3 pool. |
...
```solidity
function add(uint256 _allocPoint, LuciaPool _pool, bool _withUpdate) external
```
...
| \_pool       | LuciaPool | Address of the V3 pool.                       |
...
```solidity
event AddPool(uint256 pid, uint256 allocPoint, LuciaPool pool, ILMPool lmPool)
```
