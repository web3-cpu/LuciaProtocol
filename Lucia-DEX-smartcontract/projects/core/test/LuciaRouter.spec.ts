...
describe('LuciaPool', () => {
  ...
  let pool0: MockTimeLuciaPool
  let pool1: MockTimeLuciaPool
  ...
  let swapTargetCallee: TestLuciaCallee
  let swapTargetRouter: TestLuciaRouter
