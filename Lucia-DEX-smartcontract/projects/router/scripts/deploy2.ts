...
async function main() {
  ...
  const v3PeripheryDeployedContracts = await import(`@luciaswap/periphery/deployments/${networkName}.json`)

  const luciaPoolDeployer_address = v3DeployedContracts.LuciaPoolDeployer
