...
import '@luciaswap/core/contracts/libraries/LowGasSafeMath.sol';
...
library SmartRouterHelper {
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0xc1328d0057bb8f363bfe11ce949f6ab6c692006d7ac083341f52a0e0ba4444f2;
    ...
    /// @param deployer The LuciaSwap deployer contract address
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (ILuciaPool) {
        return ILuciaPool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid LuciaSwap Pool
    /// @param deployer The contract address of the LuciaSwap deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (ILuciaPool pool) {
    ...
    function verifyCallback(address deployer, PoolKey memory poolKey)
        public
        view
        returns (ILuciaPool pool)
    {
        pool = ILuciaPool(computeAddress(deployer, poolKey));
