...
import '@luciaswap/core/contracts/libraries/TickBitmap.sol';
...
import '@luciaswap/periphery/contracts/libraries/Path.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, ILuciaSwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    function luciaSwapCallback(
        ...
        ILuciaPool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ILuciaPool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
