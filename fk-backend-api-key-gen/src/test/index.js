...
test("Test POST /api/fingerprints", function (t) {
  ...
  request(app)
    ...
    .end(function (err,res) {
      ...
      t.same(res.body.jsonData.customer_address, newFingerprint.fingerprint.jsonData.customer_address);
      t.same(res.body.jsonData.user_agent_string, newFingerprint.fingerprint.jsonData.user_agent_string);
      t.end();
    })
})
