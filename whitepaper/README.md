...
Copyright Decentral Holding Corporation
...
## Structure of content in the file system
...
## 🙆‍♀️ How to test run Documentation Server in Prod
...
```zsh
node test/parser.test.js -p 3000
