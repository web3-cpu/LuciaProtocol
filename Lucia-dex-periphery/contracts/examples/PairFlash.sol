...
import '@lucia/v3-core/contracts/interfaces/callback/ILuciaFlashCallback.sol';
import '@lucia/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
/// @notice An example contract using the Lucia flash function
contract PairFlash is ILuciaFlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `luciaV3FlashCallback`
