import { abi as ILuciaPoolABI } from '@lucia/v3-core/artifacts/contracts/interfaces/ILuciaPool.sol/ILuciaPool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { ILuciaPool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, ILuciaPoolABI, wallet)) as [
      ILuciaPool,
      ILuciaPool,
      ILuciaPool
    ]
