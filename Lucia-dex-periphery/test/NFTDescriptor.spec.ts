...
describe('NFTDescriptor', () => {
  ...
  function constructTokenMetadata(
    ...
    return {
      ...
      description: `This NFT represents a liquidity position in a Lucia ${quoteTokenSymbol}-${baseTokenSymbol} pool. The owner of this NFT can modify or redeem the position.\n\
