...
import "./LuciaStableSwapLP.sol";

contract LuciaStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(LuciaStableSwapLP).creationCode;
        ...
        LuciaStableSwapLP(lpToken).setMinter(_minter);
