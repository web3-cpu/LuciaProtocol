...
import "./LuciaStableSwapTwoPool.sol";

contract LuciaStableSwapTwoPoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(LuciaStableSwapTwoPool).creationCode;
        ...
        LuciaStableSwapTwoPool(swapContract).initialize(
            coins,
            _A,
            _fee,
            _admin_fee,
