...
import "./interfaces/ILuciaStableSwap.sol";
import "./interfaces/ILuciaStableSwapLP.sol";
import "./interfaces/ILuciaStableSwapDeployer.sol";
import "./interfaces/ILuciaStableSwapLPFactory.sol";

contract LuciaStableSwapFactory is Ownable {
    ...
    ILuciaStableSwapLPFactory public immutable LPFactory;
    ILuciaStableSwapDeployer public immutable SwapTwoPoolDeployer;
    ILuciaStableSwapDeployer public immutable SwapThreePoolDeployer;
     ...
     */
    constructor(
        ILuciaStableSwapLPFactory _LPFactory,
        ILuciaStableSwapDeployer _SwapTwoPoolDeployer,
        ILuciaStableSwapDeployer _SwapThreePoolDeployer
    ) {
    ...
    function createSwapPair(
        ...
        ILuciaStableSwapLP(LP).setMinter(swapContract);
    ...
    function addPairInfo(address _swapContract) external onlyOwner {
        ILuciaStableSwap swap = ILuciaStableSwap(_swapContract);
