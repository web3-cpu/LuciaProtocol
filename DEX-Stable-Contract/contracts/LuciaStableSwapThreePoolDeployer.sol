...
import "./LuciaStableSwapThreePool.sol";

contract LuciaStableSwapThreePoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(LuciaStableSwapThreePool).creationCode;
        ...
        LuciaStableSwapThreePool(swapContract).initialize(
            coins,
            _A,
            _fee,
            _admin_fee,
