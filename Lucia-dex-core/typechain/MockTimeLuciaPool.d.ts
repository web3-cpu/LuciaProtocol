...
interface MockTimeLuciaPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTimeLuciaPool extends Contract {
  ...
  interface: MockTimeLuciaPoolInterface;
