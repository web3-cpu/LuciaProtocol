...
interface ILuciaPoolImmutablesInterface extends ethers.utils.Interface {
  functions: {
...
export class ILuciaPoolImmutables extends Contract {
  ...
  interface: ILuciaPoolImmutablesInterface;
