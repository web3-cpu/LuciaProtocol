...
import type { LuciaPoolDeployer } from "../LuciaPoolDeployer";

export class LuciaPoolDeployer__factory extends ContractFactory {
  constructor(signer?: Signer) {
    super(_abi, _bytecode, signer);
  }

  deploy(overrides?: Overrides): Promise<LuciaPoolDeployer> {
    return super.deploy(overrides || {}) as Promise<LuciaPoolDeployer>;
  }
  getDeployTransaction(overrides?: Overrides): TransactionRequest {
    return super.getDeployTransaction(overrides || {});
  }
  attach(address: string): LuciaPoolDeployer {
    return super.attach(address) as LuciaPoolDeployer;
  }
  connect(signer: Signer): LuciaPoolDeployer__factory {
    return super.connect(signer) as LuciaPoolDeployer__factory;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LuciaPoolDeployer {
    return new Contract(address, _abi, signerOrProvider) as LuciaPoolDeployer;
  }
}
