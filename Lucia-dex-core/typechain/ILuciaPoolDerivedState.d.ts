...
interface ILuciaPoolDerivedStateInterface extends ethers.utils.Interface {
  functions: {
...
export class ILuciaPoolDerivedState extends Contract {
  ...
  interface: ILuciaPoolDerivedStateInterface;
