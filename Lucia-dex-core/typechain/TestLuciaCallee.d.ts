...
interface TestLuciaCalleeInterface extends ethers.utils.Interface {
  functions: {
    "flash(address,address,uint256,uint256,uint256,uint256)": FunctionFragment;
    "luciaFlashCallback(uint256,uint256,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "luciaFlashCallback",
...
export class TestLuciaCallee extends Contract {
  ...
  interface: TestLuciaCalleeInterface;
  ...
  functions: {
    ...
    "luciaFlashCallback(uint256,uint256,bytes)"(
      fee0: BigNumberish,
      fee1: BigNumberish,
      data: BytesLike,
      overrides?: Overrides
