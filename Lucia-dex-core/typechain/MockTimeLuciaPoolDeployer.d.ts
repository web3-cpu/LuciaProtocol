...
interface MockTimeLuciaPoolDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTimeLuciaPoolDeployer extends Contract {
  ...
  interface: MockTimeLuciaPoolDeployerInterface;
