...
interface ILuciaPoolActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class ILuciaPoolActions extends Contract {
  ...
  interface: ILuciaPoolActionsInterface;
