...
interface ILuciaPoolOwnerActionsInterface extends ethers.utils.Interface {
  functions: {
...
export class ILuciaPoolOwnerActions extends Contract {
  ...
  interface: ILuciaPoolOwnerActionsInterface;
