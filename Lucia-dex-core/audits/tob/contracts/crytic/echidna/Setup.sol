...
import '../../../../../contracts/LuciaFactory.sol';
...
contract SetupTokens {
    ...
    constructor() public {
        ...
        // since this is what the lucia factory will do when you create the pool
...
contract LuciaMinter {
    ...
    function setPool(LuciaPool _pool) public {
        pool = _pool;
    }
...
contract LuciaSwapper {
    ...
    function luciaSwapCallbackCallback(
        int256 amount0Delta,
        int256 amount1Delta,
        bytes calldata data
    ) external {
